...
_ROLE_CHART_LAYOUTS: dict[str, list[dict]] = {
    "seller": [
        ...
        {"source_idx": 2, "type": "area", "title": "Rolling QTD Revenue"},
        {"source_idx": 3, "type": "pie", "title": "Sessions by Status"},
        {"source_idx": 4, "title": "Points Attainment % by Program"},
        {"source_idx": 5, "type": "stacked_bar", "title": "Market Revenue vs Forecast vs Target"},
    ...
    "ops_lead": [
        ...
        {"source_idx": 0, "type": "bar", "title": "Revenue QTD by Pod"},
        {"source_idx": 2, "type": "line", "title": "Rolling Revenue by Quarter"},
        {"source_idx": 4, "type": "horizontal_bar", "title": "Program Attainment %"},
        {"source_idx": 6, "type": "scatter", "title": "OSAT vs Revenue by Seller"},
    ],
    "quality_analyst": [
        {"source_idx": 6, "type": "scatter", "title": "OSAT vs Revenue QTD"},
        ...
        {"source_idx": 0, "type": "bar", "title": "Revenue by Pod (Quality Context)"},
        {"source_idx": 2, "type": "area", "title": "Quarterly Revenue Context"},
        {"source_idx": 5, "type": "stacked_bar", "title": "Market Mix Context"},
        {"source_idx": 7, "type": "composed", "title": "Revenue + Attainment Overlay"},
    ],
    "data_contributor": [
        {"source_idx": 0, "title": "Revenue QTD by Pod"},
        {"source_idx": 1, "type": "line", "title": "Daily Revenue Trend"},
        {"source_idx": 2, "type": "area", "title": "Rolling QTD Revenue"},
        {"source_idx": 3, "type": "pie", "title": "Session Distribution"},
        {"source_idx": 4, "type": "horizontal_bar", "title": "Program Attainment"},
    ...
    "pex_team": [
        ...
        {"source_idx": 1, "type": "line", "title": "Daily Revenue Trend"},
        {"source_idx": 2, "type": "area", "title": "Quarterly Revenue Progression"},
        {"source_idx": 3, "type": "pie", "title": "Session Status Mix"},
        {"source_idx": 6, "type": "scatter", "title": "OSAT vs Revenue"},
    ],
}
